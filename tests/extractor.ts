...
const imageData4 = {
  ...
  height: 2,
  data: [
    0xff, 0xff, 0x00, 0xff, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00, 0x00, 0xff,
    0xff, 0xff, 0xff, 0xff,
  ],
};
...
describe("Color", () => {
  ...
  testWarn(
    "Little pixels",
    { pixels: -1 },
    "pixels can not be less than 1 (it's -1)"
  );
  throwTest(
    "Float pixels",
    { pixels: 1.2 },
    "pixels is not a valid number (1.2)"
  );
  throwTest(
    "Large pixels",
    { pixels: Number.POSITIVE_INFINITY },
    "pixels is not a valid number (Infinity)"
  );
  testWarn(
    "Little distance",
    { distance: -0.1 },
  ...
  throwTest(
    ...
    { colorValidator: 1 as unknown as Cb },
    "colorValidator is not a function (1)"
  );
  throwTest(
    "String colorValidator",
    { colorValidator: "a" as unknown as Cb },
    "colorValidator is not a function (a)"
  );
});
