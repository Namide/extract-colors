...
import {createImageData} from './_image'
...
describe("CJS", () => {
  ...
  it("Small distance", () =>
    new Promise((done) => {
      const imageData = createImageData(2, 1, [0xffffff, 0xeeeeee]);
      return extractColors(imageData, {
        fastDistance: 0,
        distance: 0,
      }).then((data) => {
  ...
  it("Big distance", () =>
    new Promise((done) => {
      const imageData = createImageData(2, 1, [0xffffff, 0xcccccc]);
      return extractColors(imageData, {
        fastDistance: 0.3,
        distance: 0,
      }).then((data) => {
  ...
  it("Color validator", () =>
    new Promise((done) => {
      const imageData = createImageData(2, 1, [0xffffff, 0xff00bb]);
      return extractColors(imageData, {
  ...
  it("Small distance", () =>
    new Promise((done) => {
      const imageData = createImageData(2, 1, [0xff0000, 0xff1100]);
      return extractColors(imageData, {
        fastDistance: 0,
        distance: 0,
      }).then((data) => {
